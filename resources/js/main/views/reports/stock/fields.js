...
const fields = () => {
	...
	const getPreFetchData = () => {
		...
		Promise.all([usersPromise]).then(
			...
			([productsResponse]) => {
				preFetchData.products = productsResponse.data;
			}
		);
	};
