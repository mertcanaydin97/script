...
ApiRoute::group(['namespace' => 'App\Http\Controllers\Api'], function () {
    ...
    ApiRoute::get('productsf', ['as' => 'api.products.f', 'uses' => 'ProductController@index']);
    
    ApiRoute::post('search-products/{slug}/{type}', ['as' => 'api.extra.search-product-front', 'uses' => 'ProductController@frontSearch']);
    ...
    ApiRoute::group(['middleware' => ['api.permission.check', 'api.auth.check']], function () {
        ...
        ApiRoute::post('online-orders/change-single-item/{id}/{value}', ['as' => 'api.online-orders.changesingleitem', 'uses' => 'OrderItemController@updateStatus']);

        ApiRoute::get('all-orders', ['as' => 'allOrders.stock', 'uses' => 'AllOrdersController@all']);
